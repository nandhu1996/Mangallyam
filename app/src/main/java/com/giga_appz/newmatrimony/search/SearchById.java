...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter11;
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter6;
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter7;
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter8;
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter9;
...
public class SearchById extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=block";
    public int page=0;
    private String jsonResponse;
    Matcheslist matches;
    RecyclerviewAdapter11 adapter;
    ...
    public void arrayswipe(){
        page=page+1;
        SharedPreferences sharedpreferences = getActivity().getSharedPreferences("token", Context.MODE_PRIVATE);
        JsonArrayRequest req = new JsonArrayRequest("http://www.mangallyam.com/mob/list.php?tk="+sharedpreferences.getString("token", "")+"&pg="+page+urlafterpage,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_search_by_id,container,false);
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView11);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter11(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler11);
