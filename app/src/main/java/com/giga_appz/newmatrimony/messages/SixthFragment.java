...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter5;
...
public class SixthFragment extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=accepted";
    public int page=0;
    private String jsonResponse;
    Matcheslist matches;
    RecyclerviewAdapter5 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView5);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter5(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler5);
