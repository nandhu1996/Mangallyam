...
public class Requestsent extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=sent";
    public int page=0;
    private String jsonResponse;
    Matcheslist matches;
    RecyclerviewAdapter7 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView9);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter7(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler9);
