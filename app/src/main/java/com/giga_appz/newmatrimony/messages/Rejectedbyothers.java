...
public class Rejectedbyothers extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=orrejected";
    public int page=0;
    private String jsonResponse;
    Matcheslist matches;
    RecyclerviewAdapter8 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_rejectedbyothers,container,false);
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView7);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter8(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler7);
