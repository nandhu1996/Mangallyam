...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter10;
...
public class Chat extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=chat";
    public int page=0;
    private String jsonResponse;
    Matcheslist matches;
    RecyclerviewAdapter10 adapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView10);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter10(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler10);
