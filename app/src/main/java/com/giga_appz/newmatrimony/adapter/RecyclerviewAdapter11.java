 ...
 */
public class RecyclerviewAdapter11 extends RecyclerView.Adapter<RecyclerviewAdapter11.MyViewHolder> {
    ...
    public RecyclerviewAdapter11(Context context, List<Matcheslist> idavaka) {
    ...
    public void setOnItemClickListener(CustomOnClick customOnClick){
        RecyclerviewAdapter11.customOnClick=customOnClick;
    }
    @Override
