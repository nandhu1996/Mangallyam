 ...
 */
public class RecyclerviewAdapter9 extends RecyclerView.Adapter<RecyclerviewAdapter9.MyViewHolder> {
    ...
    public RecyclerviewAdapter9(Context context, List<Matcheslist> idavaka) {
    ...
    public void setOnItemClickListener(CustomOnClick customOnClick){
        RecyclerviewAdapter9.customOnClick=customOnClick;
    }
    @Override
