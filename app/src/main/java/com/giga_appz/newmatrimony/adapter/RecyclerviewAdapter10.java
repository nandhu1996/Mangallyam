 ...
 */
public class RecyclerviewAdapter10 extends RecyclerView.Adapter<RecyclerviewAdapter10.MyViewHolder> {
    ...
    public RecyclerviewAdapter10(Context context, List<Matcheslist> idavaka) {
    ...
    public void setOnItemClickListener(CustomOnClick customOnClick){
        RecyclerviewAdapter10.customOnClick=customOnClick;
    }
    @Override
