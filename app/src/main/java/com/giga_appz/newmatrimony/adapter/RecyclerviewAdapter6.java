 ...
 */
public class RecyclerviewAdapter6 extends RecyclerView.Adapter<RecyclerviewAdapter6.MyViewHolder> {
    ...
    public RecyclerviewAdapter6(Context context, List<Matcheslist> idavaka) {
    ...
    public void setOnItemClickListener(CustomOnClick customOnClick){
        RecyclerviewAdapter6.customOnClick=customOnClick;
    }
    @Override
