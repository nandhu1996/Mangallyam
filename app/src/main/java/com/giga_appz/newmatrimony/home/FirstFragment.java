...
public class FirstFragment extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=newmatches";
    public int page=0;
...
/*
* Json Array Request to fetch data in new matches Tab
* */
    ...
    /*
    * Json array request on swiping and page number is also incremented here*/
    ...
    /*
    * Custom click implimented for the list and click on image and view profile is coded here
    * */
    ...
    public void onItemClick(final View view, int position) {
        switch (view.getId()) {
            case R.id.profile_image:
                ...
                final ImageView profileopen=(ImageView)dialog.findViewById(R.id.profileenlarge);
    ...
    /*
    * Display alert box when internet is not available
    * */
