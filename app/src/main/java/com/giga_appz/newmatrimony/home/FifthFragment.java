...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter4;
...
public class FifthFragment extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=visited";
    public int page=0;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView4);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter4(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler4);
