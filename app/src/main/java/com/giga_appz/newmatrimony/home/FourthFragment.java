...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter3;
...
public class FourthFragment extends Fragment implements CustomOnClick {
    ...
    public void makeJsonArrayRequest() {
        ...
        System.out.println("urlview=="+urlJsonArry+sharedpreferences.getString("token", "")+urlaftertk+page+urlafterpage);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView
                .findViewById(R.id.loadItemsLayout_listView3);
        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter3(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler3);
