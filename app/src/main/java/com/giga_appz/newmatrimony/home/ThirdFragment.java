...
import com.giga_appz.newmatrimony.adapter.RecyclerviewAdapter2;
...
public class ThirdFragment extends Fragment implements CustomOnClick {
    ...
    String urlafterpage="&mt=requests";
    public int page=0;
    ...
    public void makeJsonArrayRequest() {
        ...
        System.out.println("url=="+urlJsonArry+sharedpreferences.getString("token", "")+urlaftertk+page+urlafterpage);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        bottomLayout = (RelativeLayout) rootView.findViewById(R.id.loadItemsLayout_listView2);

        makeJsonArrayRequest();
        adapter = new RecyclerviewAdapter2(getActivity(), list);
        adapter.setOnItemClickListener(this);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler2);
